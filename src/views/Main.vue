...
<template>
    <div class="main" :class="{'main-hide-text': hideMenuText}">
        <div class="sidebar-menu-con nano" :style="{width: hideMenuText?'60px':'200px',  background: $store.state.menuTheme === 'dark'?'#495060':'white'}">
        ...
        <div class="main-header-con" :style="{paddingLeft: hideMenuText?'60px':'200px'}">
            <div class="main-header">
                ...
                <div class="header-middle-con" style="padding: 0;">
                    <top-nav :department="department" v-on:top-nav="getCurrentDepartment"></top-nav>
                </div>
                <div class="header-avator-con">
                    ...
                    <div class="switch-theme-con">
                        ...
                        <!-- <Tooltip content="更换主题" :delay="1000"> -->
                                <theme-dropdown-menu></theme-dropdown-menu>
                        <!-- </Tooltip> -->
                    </div>
...
<script>
    ...
    import topNav from './main_components/topNav.vue';
