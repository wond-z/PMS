        ...
        <card class="margin-bottom-10 padding-top-bottom-minish">
            <div class="select-col">
                ...
                <div class="div">
                    ...
                    <Date-picker :options="options" placement="bottom-end" format="yyyy年MM月dd日" placeholder="选择日期" class="select" @on-change='dateFormatStart'></Date-picker>
                </div>
                <!-- <a id="hrefToExportTable" style="postion: absolute;left: -10px;top: -10px;width: 0px;height: 0px;"></a> -->
                <Button type="primary" icon="ios-upload" @click="exportExcel">导出Excel</Button>
            </div>
		</card>
        <card>
            <r-table ref="tableExcel" :type='type' :list='list' :material='material' :proUnit='useCmp' :date='someDay'>
                    <tbody slot="head">
                        <tr class="table-head">
                            <td colspan="13">{{goodType || '油管'}}管体日生产报表</td>
                        </tr>
                        <tr class="border-none">
                            ...
                            <td colspan="3">规格(mm)：{{specification}}</td>
                            <td colspan="2" class="align-right">编号：SYC/ZJ-GT-13</td>
                        </tr>
                        <tr>
                            <td colspan="2" rowspan="2" ref="first" class="first">
                                <span class="bias" :style="first"></span>
                                <p style="text-align: right;">班组</p>
...
<script>
    ...
    import printTable from '@/libs/printTable.js';
        ...
        computed:{
            first(){
                return {
                    ...
                    display: 'block',
                    transform: 'rotate(-'+ this.angleX +'deg)',
                }
            }
        },
        methods:{
            exportExcel () {
                printTable.transform(this.$refs.tableExcel, 'hrefToExportTable', '分厂日报表');
            },
            showProCmp(data){
                base.showGoodsInfo({
                    'vm':this,
            ...
            setBias(){
                ...
                this.angleX = Math.atan2(otd.offsetWidth,otd.offsetHeight);
