        ...
        data () {
            return {
                ...
                columns: [                   // 表格表头/列信息
                    ...
                    {key: "ShouPoundWeight", title: "到货量",align: 'center',ellipsis:true},
                    {key: "ShouNumber", title: "发货量",align: 'center',ellipsis:true},
                    {key: "FaPoundWeight", title: "收发结存",align: 'center',ellipsis:true},
                ],
                array: [{id:1},{id:2}],
                outStoreIsShow: false,
                inStoreIsShow: false,
            }
        },
        methods: {
            inStoreShow(){
                if(this.inStoreIsShow == false ){
                    this.inStoreIsShow = true;
                }else if(this.inStoreIsShow == true){
                    this.inStoreIsShow = false
                }
            },
            outStoreShow(){
                if(this.outStoreIsShow == false ){
                    this.outStoreIsShow = true;
                }else if(this.outStoreIsShow == true){
                    this.outStoreIsShow = false
                }
            },
            dateStrat(val){
                this.startDate = val;
