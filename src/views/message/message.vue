...
export default {
    ...
    methods: {
        ...
        getContent (index) {
            ...
            switch (this.currentMessageType + index) {
                case 'unread0': mesContent = '这是您点击的《欢迎登录延长石油材料厂后台管理系统，来了解他的用途吧》的相关内容。'; break;
                case 'unread1': mesContent = '这是您点击的《使用延长石油材料厂快速搭建你的后台系统吧》的相关内容。'; break;
                case 'unread2': mesContent = '这是您点击的《喜欢延长石油材料厂的话，欢迎到github主页给个star吧》的相关内容。'; break;
    ...
    mounted () {
        this.currentMesList = this.unreadMesList = [
            {
                title: '欢迎登录延长石油材料厂后台管理系统，来了解他的用途吧',
                time: 1507390106000
            },
            {
                title: '使用延长石油材料厂快速搭建你的后台系统吧',
                time: 1507390106000
            },
            {
                title: '喜欢延长石油材料厂的话，欢迎到github主页给个star吧',
                time: 1507390106000
            }
        ];
        this.hasreadMesList = [
